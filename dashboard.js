...
import { getFirestore, doc, getDoc, collection, addDoc, query, where, getDocs, deleteDoc } from "https://www.gstatic.com/firebasejs/10.12.0/firebase-firestore.js";
...
onAuthStateChanged(auth, async (user) => {
  ...
  if (!querySnapshot.empty) {
    ...
    sellerName.textContent = sellerData.businessName;
    sellerEmail.textContent = "Email: " + sellerData.email;
    sellerPhone.textContent = "Phone: " + sellerData.phone;
